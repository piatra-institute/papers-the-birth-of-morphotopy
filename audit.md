...
- references.yaml: 41 CSL entries. 16 journal articles and books resolved through doi.org or Crossref and checked for year, title and authors (Kriegeskorte et al. co-authors added by hand); 8 arXiv works resolved through their arXiv DOIs (10.48550/arXiv.*); 17 entered by hand from the legacy text (amari2000, beltrami1868, bengio2003, chalmers1995, desargues1639, descartes1637, euclid1956, gauss1828, gibbs1902, klein1872, lobachevsky1829, maclane1992, mcghee1999, poincare1895, raup1966, riemann1868, saccheri1733; Crossref's title search had matched gibbs1902 and mcghee1999 to book reviews). Ids renamed: mac1992 -> maclane1992, clifford1873 -> riemann1873 (Riemann, translated by Clifford).
- Citations: author-year forms converted to Pandoc syntax; 24 entries that the prose named with a date but did not cite parenthetically now carry a citation where the text names the work (e.g. "Descartes' La Geometrie of 1637 [@descartes1637]", "Bronstein and colleagues [-@bronstein2021]", "Projective geometry [@desargues1639]"). No sentence or number changed.
- Corrections: engels2024 authors Engels, Liao, Michaud, Gurnee, Tegmark -> Engels, Michaud, Liao, Gurnee, Tegmark (arXiv record), title updated to the current arXiv title "Not All Language Model Features Are One-Dimensionally Linear"; desargues1639 title spelling -> "aux evenemens des rencontres du cone avec un plan" (1639 spelling); Kriegeskorte et al. co-authors restored (the Crossref record lists only the first author).
- claims.yaml: 51 claims (27 computation, 12 source, 8 interpretation, 3 definition, 1 assumption). Every stratigraphy and frustration number in the abstract and Section 8 is bound to simulation/output/results.json. Source claims checked against abstracts (arXiv DOI records or arxiv.org for Gurnee-Tegmark, Li et al., Nanda et al., Engels et al., Kantamneni-Tegmark, Huh et al., Bronstein et al.; Crossref for Durant et al., Levin, Kriegeskorte et al., Tymoczko, Bramwell-Gingras).
- Not verifiable from retrievable abstracts, left unbound: Mitteroecker and Huttegger on non-Euclidean morphospaces (abstract elided by publisher); Billera, Holmes and Vogtmann on non-positive curvature (abstract elided); Raup's four coiling parameters (JSTOR, no abstract); Wannier's residual entropy 0.3231 (bound only as a stored constant); Pauling's ice entropy; Gardenfors on convex regions; Carlsson on persistent homology (abstract retrieved but does not state the construction); Euclid's counts of definitions and propositions; historical dates in Sections 2-5.
- Run: morphotopy (uv run python run_all.py), reproduced results.json byte-identically; receipt verification/morphotopy.json.
